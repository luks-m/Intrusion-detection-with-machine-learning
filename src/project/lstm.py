...
if __name__ == "__main__":
   ...
   # print("\n Reformated logs : \n", logs)
    ...
    #Model LSTM
    model = Sequential()
    model.add(LSTM(1000, input_shape=(LOG_LENGTH, gen.NB_INPUTS)))
    ...
    history = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=20, batch_size=20, callbacks=[checkpoint])
